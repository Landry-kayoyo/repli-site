...
(function(){
  var UID='{uid}';
  var CATS={
    'Code':['bi-code-slash','bi-code-square','bi-code','bi-code-dot','bi-braces','bi-braces-asterisk','bi-terminal','bi-terminal-fill','bi-git','bi-github','bi-gitlab','bi-journal-code','bi-file-earmark-code','bi-bug','bi-bug-fill','bi-textarea','bi-input-cursor','bi-hash','bi-filetype-py','bi-filetype-js','bi-filetype-jsx','bi-filetype-ts','bi-filetype-tsx','bi-filetype-html','bi-filetype-css','bi-filetype-json','bi-filetype-php','bi-filetype-java','bi-filetype-cs','bi-filetype-rb','bi-filetype-sql','bi-filetype-xml','bi-filetype-go','bi-filetype-sh','bi-filetype-yml','bi-filetype-csv','bi-filetype-pdf','bi-filetype-mp3','bi-filetype-mp4','bi-browser-chrome','bi-browser-firefox','bi-browser-safari','bi-browser-edge','bi-bootstrap'],
    'Cloud':['bi-database','bi-database-fill','bi-database-check','bi-database-add','bi-server','bi-hdd-network','bi-hdd-rack','bi-cloud','bi-cloud-fill','bi-cloud-upload','bi-cloud-download','bi-cloud-check','bi-cloud-arrow-up','bi-diagram-3','bi-diagram-2','bi-graph-up','bi-graph-down','bi-bar-chart','bi-bar-chart-fill','bi-bar-chart-line-fill','bi-pie-chart','bi-pie-chart-fill','bi-activity','bi-layers','bi-stack','bi-boxes','bi-box','bi-flow'],
    'UI':['bi-search','bi-eye','bi-eye-fill','bi-eye-slash','bi-pencil','bi-pencil-fill','bi-pencil-square','bi-trash','bi-trash-fill','bi-trash3','bi-plus','bi-plus-circle','bi-plus-circle-fill','bi-dash','bi-x','bi-x-circle','bi-check','bi-check-circle','bi-check-circle-fill','bi-check2','bi-arrow-right','bi-arrow-left','bi-arrow-up','bi-arrow-down','bi-arrow-right-circle','bi-arrows-expand','bi-chevron-right','bi-chevron-left','bi-download','bi-upload','bi-share','bi-share-fill','bi-filter','bi-funnel','bi-sort-down','bi-sort-up','bi-sliders','bi-gear','bi-gear-fill','bi-gear-wide','bi-grid','bi-grid-fill','bi-list','bi-list-ul','bi-list-check','bi-table','bi-kanban','bi-kanban-fill','bi-layout-sidebar','bi-columns','bi-zoom-in','bi-zoom-out','bi-fullscreen','bi-bell','bi-bell-fill','bi-toggle-on','bi-toggle-off','bi-send','bi-send-fill','bi-bookmark','bi-bookmark-fill','bi-bookmark-heart','bi-bookmark-star','bi-tag','bi-tag-fill','bi-tags','bi-flag','bi-flag-fill','bi-star','bi-star-fill','bi-heart','bi-heart-fill','bi-link','bi-link-45deg','bi-globe','bi-globe2','bi-clipboard','bi-clipboard-fill','bi-clipboard-check','bi-qr-code','bi-display','bi-printer','bi-chat','bi-chat-dots','bi-chat-fill','bi-chat-left-text','bi-envelope','bi-envelope-fill','bi-envelope-at','bi-rss','bi-rss-fill'],
    'Medias':['bi-camera','bi-camera-fill','bi-camera-video','bi-camera-video-fill','bi-image','bi-image-fill','bi-images','bi-music-note','bi-music-note-beamed','bi-play','bi-play-fill','bi-play-circle','bi-pause','bi-pause-fill','bi-stop','bi-stop-fill','bi-video','bi-video-fill','bi-mic','bi-mic-fill','bi-headphones','bi-headset','bi-speaker','bi-volume-up','bi-volume-down','bi-file-earmark-pdf','bi-file-earmark-zip','bi-file-earmark-text','bi-file-earmark','bi-newspaper','bi-book','bi-book-fill','bi-bookshelf','bi-journal-text','bi-collection-play'],
    'Design':['bi-palette','bi-palette-fill','bi-palette2','bi-brush','bi-brush-fill','bi-pen','bi-pen-fill','bi-vector-pen','bi-scissors','bi-crop','bi-bezier','bi-bezier2','bi-bounding-box','bi-bounding-box-circles','bi-layout-text-window','bi-layout-three-columns','bi-rulers','bi-border-all','bi-layers','bi-layer-backward','bi-layer-forward','bi-magic','bi-stars','bi-brilliance','bi-highlighter','bi-type','bi-type-bold','bi-type-italic','bi-type-h1','bi-type-h2','bi-type-h3','bi-justify','bi-text-left','bi-text-center','bi-text-paragraph','bi-aspect-ratio','bi-symmetry-horizontal','bi-symmetry-vertical','bi-grid-1x2','bi-grid-3x3'],
    'Personnes':['bi-person','bi-person-fill','bi-person-circle','bi-person-bounding-box','bi-people','bi-people-fill','bi-person-badge','bi-person-check','bi-person-plus','bi-person-x','bi-person-workspace','bi-person-video','bi-person-raised-hand','bi-building','bi-building-fill','bi-briefcase','bi-briefcase-fill','bi-house','bi-house-fill','bi-geo-alt','bi-geo-alt-fill','bi-map','bi-map-fill','bi-award','bi-award-fill','bi-trophy','bi-trophy-fill','bi-mortarboard','bi-mortarboard-fill','bi-journal','bi-journal-richtext','bi-globe-americas','bi-translate'],
    'Finance':['bi-currency-bitcoin','bi-currency-ethereum','bi-currency-euro','bi-currency-dollar','bi-currency-pound','bi-currency-yen','bi-credit-card','bi-credit-card-fill','bi-credit-card-2-back','bi-wallet','bi-wallet-fill','bi-wallet2','bi-cash','bi-cash-coin','bi-cash-stack','bi-cart','bi-cart-fill','bi-cart-plus','bi-bag','bi-bag-fill','bi-bag-check','bi-shop','bi-shop-window','bi-truck','bi-box-seam','bi-receipt','bi-receipt-cutoff','bi-piggy-bank','bi-piggy-bank-fill'],
    'Reseaux':['bi-github','bi-gitlab','bi-stack-overflow','bi-linkedin','bi-twitter','bi-twitter-x','bi-facebook','bi-instagram','bi-youtube','bi-tiktok','bi-twitch','bi-reddit','bi-pinterest','bi-discord','bi-slack','bi-telegram','bi-whatsapp','bi-signal','bi-skype','bi-wechat','bi-tencent-qq','bi-snapchat','bi-mastodon','bi-medium','bi-behance','bi-dribbble','bi-vimeo','bi-spotify','bi-google','bi-google-play','bi-apple','bi-microsoft','bi-microsoft-teams','bi-amazon','bi-paypal','bi-wordpress','bi-bootstrap','bi-envelope','bi-envelope-at','bi-chat-dots','bi-rss'],
    'Systeme':['bi-cpu','bi-cpu-fill','bi-memory','bi-gpu-card','bi-laptop','bi-laptop-fill','bi-pc-display','bi-pc-display-horizontal','bi-phone','bi-phone-fill','bi-tablet','bi-tablet-fill','bi-smartwatch','bi-wifi','bi-wifi-off','bi-bluetooth','bi-usb-symbol','bi-hdmi','bi-lock','bi-lock-fill','bi-unlock','bi-unlock-fill','bi-shield','bi-shield-check','bi-shield-fill','bi-shield-lock','bi-key','bi-key-fill','bi-tools','bi-wrench','bi-wrench-adjustable','bi-android2','bi-apple','bi-windows','bi-linux','bi-ubuntu','bi-robot','bi-moon','bi-moon-fill','bi-sun','bi-sun-fill','bi-brightness-high','bi-clock','bi-clock-fill','bi-calendar','bi-calendar-fill','bi-calendar-check','bi-alarm','bi-alarm-fill','bi-hourglass','bi-info-circle','bi-question-circle','bi-exclamation-triangle','bi-exclamation-circle','bi-lightning','bi-lightning-fill','bi-fire','bi-rocket','bi-rocket-fill','bi-heart-pulse','bi-heart-pulse-fill','bi-thermometer','bi-speedometer','bi-speedometer2']
  };
  var LABELS={'Code':'&#128187; Code','Cloud':'&#9729; Cloud & Data','UI':'&#128433; UI','Medias':'&#127916; Medias','Design':'&#127912; Design','Personnes':'&#128100; Personnes','Finance':'&#128176; Finance','Reseaux':'&#127760; Reseaux','Systeme':'&#9881; Systeme'};
  var ALL=[];var seen={};
