...
urlpatterns = [
    ...
    path('admin-ai/generate-content/', __import__('core.ai_views', fromlist=['ai_generate_content']).ai_generate_content, name='admin-ai-generate-content'),
    path('admin-ai/optimize-content/', __import__('core.ai_views', fromlist=['ai_optimize_content']).ai_optimize_content, name='admin-ai-optimize-content'),
